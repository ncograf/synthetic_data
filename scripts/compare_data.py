...
def compare_garch():
    ...
    real_scaled_log = scaled_log_return_statistic.ScaledLogReturnStatistic(
        quantile=quantile, window=100
    )
    ...
    synthetic_data = stock_price_statistic.StockPriceStatistic(
        quantile=quantile, legend_postfix=" - GARCH"
    )
    ...
    syn_scaled_log = scaled_log_return_statistic.ScaledLogReturnStatistic(
        quantile=quantile, window=100
    )

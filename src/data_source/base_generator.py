...
class BaseGenerator:
    ...
    def fit_model(self, price_data : npt.ArrayLike, **kwargs):
        ...
        """
        raise NotImplementedError("This function must be implemented by the class which inherits")     
    ...
    @abstractmethod
    def generate_data(self, len : int = 500, burn : int = 100, **kwargs) -> Tuple[npt.NDArray, npt.NDArray]:

...
import numpy as np
import pandas as pd
import regime_cond_flow_generator
import torch
...
class RegimeFlowIndexGenerator(base_index_generator.BaseIndexGenerator):
    def __init__(self):
        self.model_name = "regime_cond_flow"
        self.model_desc = "Regime Conditional Flow Model"
    ...
    def fit(
        ...
        Args:
            ...
            config(Dict[str, Any]): configuration for training run:
                ...
                regime_cond_flow_config:
                    ...
                    n_layer (int): number of spectral layers to be useTTd
        ...
        _MODEL_NAME = "regime_cond_flow.pt"

        # check out cpu the main process is running on
        device = torch.device("cpu")
        cpu_name = cpuinfo.get_cpu_info()["brand_raw"]
        print("Regime Conditional Flow Generator is using:")
        ...
        gen = regime_cond_flow_generator.RegimeCondFlowGenerator()
        model_desc = gen.fit(
    ...
    def sample(
        ...
        generator = regime_cond_flow_generator.RegimeCondFlowGenerator()

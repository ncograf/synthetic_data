...
class FinGanIndexGenerator:
    def __init__(self):
        self.model_desc = "Fin Gan Base Model"
        self.model_name = "fin_gan_base"
    ...
    def fit(
        ...
        print("Fin Gan Generator is using:")
        ...
        gen = fin_gan_generator.FinGanGenerator()
        log_likelyhood = []
    ...
    def sample(
        ...
        generator = fin_gan_generator.FinGanGenerator()
